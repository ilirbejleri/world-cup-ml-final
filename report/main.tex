...
\begin{center}
\small
\textbf{Top-ten 2026 champion probability excerpt.} The full 48-team forecast
across all simulator variants is reported in Table~\ref{tab:forecastvariants}.
Values are percentages.\\[0.5em]
\begin{tabular}{lrr}
\toprule
Team & Primary model & Polymarket \\
\midrule
Spain & 14.9 & 15.3 \\
Argentina & 12.6 & 8.7 \\
France & 9.1 & 16.4 \\
...
forecast variants: Poisson-only, the primary NN-original-18 hybrid, the
...
explanation. Our primary Spain estimate being close to Polymarket is therefore
a sanity check on calibration, not a proof that the model is correct. Markets
